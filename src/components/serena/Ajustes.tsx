          ...
          <section className="rounded-3xl bg-card p-5 shadow-soft">
            ...
            {enviado ? (
              ...
              <button
                ...
                disabled={cargando}
                className="press mt-4 w-full rounded-2xl bg-dawn px-4 py-3 text-sm font-bold text-primary-foreground shadow-soft disabled:opacity-60 hover:shadow-md transition-shadow"
              >
